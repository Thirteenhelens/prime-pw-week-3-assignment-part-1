...
let foodArray = ['Ramen', 'Mac & Cheese', 'Chicken', 'Tofu'];

// 1.b. TODO: Log your array of foods to the console with a message, similar
//      to the example above
console.log('Some tasty foods are: ', foodArray);
...
foodArray.push('Cookies');
console.log('Added a food to hte end,', foodArray);
